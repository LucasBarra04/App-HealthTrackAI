    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View style={styles.statsRow}>
          <MetricCard
            title="Média"
            value={`${avg} ${selectedMetric === 'agua' ? 'L' : selectedMetric === 'sono' ? 'h' : ''}`}
          />

          <MetricCard
            title="Melhor dia"
            value={bestDayDate === '-' ? '-' : bestDayDate.split('-').slice(1).join('/')}
          />
            ...
            .map((item, index) => (
              ...
              >
                ...
                <View style={styles.recentIcons}>
                  ...
                  {selectedMetric === 'humor' && (
                    <Ionicons name="happy" size={16} color="#FFB74D" />
                  )}
                </View>
              </View>
            ))}
